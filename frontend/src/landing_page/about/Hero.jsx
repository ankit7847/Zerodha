...
function Hero() {
    return ( 
        <div className='container border-bottom pb-5' style={{ backgroundColor: "#f9f9f9" }}>
            ...
            {/* Hero Content */}
            <div className="row p-4 mt-5 text-muted" style={{ lineHeight: "1.8", fontSize: "1.2em" }}>
                ...
                <div className="col-12 col-md-6 p-4">
                    ...
                    <p>
                        <a href="https://rainmatter.com" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
                            Rainmatter
